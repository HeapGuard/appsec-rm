...
export interface DailyLog { id: string; date: string; topicIds: string[]; subtopicIds?: string[]; minutes: number; learned: string; practiced: string; explanation: string; unclear: string; usefulness: number; createdAt: string; }
